...
local WebhookURL =
    "https://discord.com/api/webhooks/1302245095566872616/scicKkQvt85A6ZRr_v5bUMANv1y7rlgSNxpEJGmeEzOoLWa6VVZQZwih2nlQxT-bNfI2"
...
Interface.BlurManager = blurEffect
    ...
    alert("chisaki", "Endpoint reached")
    ...
    for _, Child in (MobTable) do
        ...
        elseif not NearbyHit then 
            ...
            if (os.time() - LastFound) > 200 then 
                alert("chisaki", "Error while farming, rejoin")
...
FunctionsHandler.Trevor:RegisterMethod("Start", function() 
    ...
    alert("[ chisaki ]", "Pulling fruit for trevor...")
